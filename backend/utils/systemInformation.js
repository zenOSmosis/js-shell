...
const SYSINFO_MODE_SYSTEM = 'SYSTEM';
const SYSINFO_MODE_BIOS = 'BIOS';
const SYSINFO_MODE_BASEBOARD = 'BASEBOARD';
const SYSINFO_MODE_CHASSIS = 'CHASSIS';
const SYSINFO_MODE_CPU = 'CPU';
const SYSINFO_MODE_CPUFLAGS = 'CPUFLAGS';
const SYSINFO_MODE_CPUCACHE = 'CPUCACHE';
const SYSINFO_MODE_CPUCURRENTSPEED = 'CPUCURRENTSPEED';
const SYSINFO_MODE_CPUTEMPERATURE = 'CPUTEMPERATURE';
const SYSINFO_MODE_MEM = 'MEM';
const SYSINFO_MODE_MEMLAYOUT = 'MEMLAYOUT';
const SYSINFO_MODE_BATTERY = 'BATTERY';
const SYSINFO_MODE_GRAPHICS = 'GRAPHICS';
const SYSINFO_MODE_OSINFO = 'OSINFO';
const SYSINFO_MODE_UUID = 'UUID';
const SYSINFO_MODE_VERSIONS = 'VERSIONS';
const SYSINFO_MODE_SHELL = 'SHELL';
const SYSINFO_MODE_USERS = 'USERS';
const SYSINFO_MODE_CURRENTLOAD = 'CURRENTLOAD';
const SYSINFO_MODE_FULLLOAD = 'FULLLOAD';
const SYSINFO_MODE_PROCESSES = 'PROCESSES';
// const SYSINFO_MODE_PROCESSLOAD = 'PROCESSLOAD';
const SYSINFO_MODE_SERVICES = 'SERVICES';
const SYSINFO_MODE_DISKLAYOUT = 'DISKLAYOUT';
const SYSINFO_MODE_BLOCKDEVICES = 'BLOCKDEVICES';
const SYSINFO_MODE_DISKSIO = 'DISKSIO';
const SYSINFO_MODE_FSSIZE = 'FSSIZE';
const SYSINFO_MODE_FSSTATS = 'FSSTATS';
const SYSINFO_MODE_NETWORKINTERFACES = 'NETWORKINTERFACES';
const SYSINFO_MODE_NETWORKINTERFACEDEFAULT = 'NETWORKINTERFACEDEFAULT';
// const SYSINFO_MODE_NETWORKSTATS = 'NETWORKSTATS';
const SYSINFO_MODE_NETWORKCONNECTIONS = 'NETWORKCONNECTIONS';
// const SYSINFO_MODE_INETCHECKSITE = 'INETCHECKSITE';
// const SYSINFO_MODE_INETLATENCY = 'INETLATENCY';
// const SYSINFO_MODE_DOCKERCONTAINERS = 'DOCKERCONTAINERS';
// const SYSINFO_MODE_DOCKERCONTAINERSTATS = 'DOCKERCONTAINERSTATS';
// const SYSINFO_MODE_DOCKERCONTAINERPROCESSES = 'DOCKERCONTAINERPROCESSES';
...
const fetchSystemInformation = async (mode) => {
  try {
